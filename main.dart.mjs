...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm} = {}) {
    ...
    const dart2wasm = {
      ...
      _1943: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      _1944: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      ...
      _2014: x0 => new Array(x0),
      _2016: x0 => x0.length,
      _2018: (x0,x1) => x0[x1],
      _2019: (x0,x1,x2) => x0[x1] = x2,
      _2022: (x0,x1,x2) => new DataView(x0,x1,x2),
      _2024: x0 => new Int8Array(x0),
      _2025: (x0,x1,x2) => new Uint8Array(x0,x1,x2),
      _2026: x0 => new Uint8Array(x0),
      _2034: x0 => new Int32Array(x0),
      _2036: x0 => new Uint32Array(x0),
      _2038: x0 => new Float32Array(x0),
      _2040: x0 => new Float64Array(x0),
      ...
      _2075: x0 => new WeakRef(x0),
      _2076: x0 => x0.deref(),
      _2082: Date.now,
      _2084: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _2085: s => {
      ...
      _2087: () => typeof dartUseDateNowForTicks !== "undefined",
      _2088: () => 1000 * performance.now(),
      _2089: () => Date.now(),
      _2090: () => {
      ...
      _2092: () => new WeakMap(),
      _2093: (map, o) => map.get(o),
      _2094: (map, o, v) => map.set(o, v),
      _2095: () => globalThis.WeakRef,
      _2106: s => JSON.stringify(s),
      _2107: s => printToConsole(s),
      _2108: a => a.join(''),
      _2109: (o, a, b) => o.replace(a, b),
      _2111: (s, t) => s.split(t),
      _2112: s => s.toLowerCase(),
      _2113: s => s.toUpperCase(),
      _2114: s => s.trim(),
      _2115: s => s.trimLeft(),
      _2116: s => s.trimRight(),
      _2118: (s, p, i) => s.indexOf(p, i),
      _2119: (s, p, i) => s.lastIndexOf(p, i),
      _2120: (s) => s.replace(/\$/g, "$$$$"),
      _2121: Object.is,
      _2122: s => s.toUpperCase(),
      _2123: s => s.toLowerCase(),
      _2124: (a, i) => a.push(i),
      _2128: a => a.pop(),
      _2129: (a, i) => a.splice(i, 1),
      _2131: (a, s) => a.join(s),
      _2132: (a, s, e) => a.slice(s, e),
      _2134: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _2135: a => a.length,
      _2137: (a, i) => a[i],
      _2138: (a, i, v) => a[i] = v,
      ...
      _2142: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      ...
      _2145: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _2146: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _2147: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _2149: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _2150: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _2151: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _2152: (t, s) => t.set(s),
      _2154: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _2156: o => o.buffer,
      _2157: o => o.byteOffset,
      _2158: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _2159: (b, o) => new DataView(b, o),
      _2160: (b, o, l) => new DataView(b, o, l),
      _2161: Function.prototype.call.bind(DataView.prototype.getUint8),
      _2162: Function.prototype.call.bind(DataView.prototype.setUint8),
      _2163: Function.prototype.call.bind(DataView.prototype.getInt8),
      _2164: Function.prototype.call.bind(DataView.prototype.setInt8),
      _2165: Function.prototype.call.bind(DataView.prototype.getUint16),
      _2166: Function.prototype.call.bind(DataView.prototype.setUint16),
      _2167: Function.prototype.call.bind(DataView.prototype.getInt16),
      _2168: Function.prototype.call.bind(DataView.prototype.setInt16),
      _2169: Function.prototype.call.bind(DataView.prototype.getUint32),
      _2170: Function.prototype.call.bind(DataView.prototype.setUint32),
      _2171: Function.prototype.call.bind(DataView.prototype.getInt32),
      _2172: Function.prototype.call.bind(DataView.prototype.setInt32),
      _2175: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _2176: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _2177: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _2178: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _2179: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _2180: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _2193: () => new XMLHttpRequest(),
      _2194: (x0,x1,x2) => x0.open(x1,x2),
      _2195: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      _2196: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      _2197: x0 => x0.abort(),
      _2198: x0 => x0.abort(),
      _2199: x0 => x0.abort(),
      _2200: x0 => x0.abort(),
      _2201: (x0,x1) => x0.send(x1),
      _2202: x0 => x0.send(),
      _2204: x0 => x0.getAllResponseHeaders(),
      _2205: (o, t) => o instanceof t,
      ...
      _2209: o => Object.keys(o),
      _2210: (ms, c) =>
      setTimeout(() => dartInstance.exports.$invokeCallback(c),ms),
      _2211: (handle) => clearTimeout(handle),
      _2212: (ms, c) =>
      setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
      _2213: (handle) => clearInterval(handle),
      _2214: (c) =>
      queueMicrotask(() => dartInstance.exports.$invokeCallback(c)),
      _2215: () => Date.now(),
      _2222: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._2222(f,arguments.length,x0) }),
      _2223: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._2223(f,arguments.length,x0) }),
      _2229: (x0,x1) => x0.appendChild(x1),
      _2230: x0 => x0.click(),
      _2231: x0 => x0.remove(),
      ...
      _2458: x0 => x0.readyState,
      _2460: (x0,x1) => x0.timeout = x1,
      ...
      _4346: x0 => x0.navigator,
      _4608: x0 => x0.trustedTypes,
      _4737: x0 => x0.userAgent,
      _7063: () => globalThis.document,
      _7156: x0 => x0.body,
      _7158: x0 => x0.head,
      _12053: (x0,x1) => x0.display = x1,
      _14012: () => globalThis.console,
      _14043: x0 => x0.name,
