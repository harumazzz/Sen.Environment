...
namespace Sen::Kernel::Support::PopCap::Package
{
        ...
        const PackageInfomartion &nlohmann_json_t) -> void
    {
        ...
        default:
            assert_conditional(false, format(fmt::format("{}", Language::get("popcap.package.invalid_package_platform")), std::to_string(nlohmann_json_j["package_platform"].get<uint8_t>())), "to_json");
        }
        ...
        PackageInfomartion &nlohmann_json_t) -> void
    {
        ...
        default:
            assert_conditional(false, format(fmt::format("{}", Language::get("popcap.package.invalid_package_platform")), package_platform_string), "from_json");
        }
