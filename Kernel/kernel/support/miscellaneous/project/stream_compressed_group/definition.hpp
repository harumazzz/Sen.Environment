...
namespace Sen::Kernel::Support::Miscellaneous::Project::StreamCompressedGroup
{
    ...
    inline static auto k_data_type_table = std::map<DataType, std::string_view>{
            ...
            DataType const &data) -> std::string_view
        {
            ...
            assert_conditional(false, format(fmt::format("{}", Language::get("project.scg.invalid_data_type")), std::to_string(static_cast<uint8_t>(data))), "exchange_data_type");
        }
            ...
            std::string_view const &data) -> DataType
        {
            ...
            assert_conditional(false, format(fmt::format("{}", Language::get("project.scg.invalid_data_type")), data), "exchange_data_type");
        }
    */
        ...
        std::string_view const &data) -> DataType
    {
        ...
        assert_conditional(data_type.has_value(), format(fmt::format("{}", Language::get("project.scg.invalid_data_type")), data), "exchange_data_type");
