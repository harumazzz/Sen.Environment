...
namespace Sen::Kernel::Encryption::Rijndael {
    ...
    template <auto mode> requires std::is_same_v<mode, type_of<Mode>>
    ...
    public:
        ...
        ) -> void
        {
            ...
            rijndael.Decrypt(reinterpret_cast<char const *>(source.cbegin()), reinterpret_cast<char const*>(destination.begin()), source.size(), mode);
        }
