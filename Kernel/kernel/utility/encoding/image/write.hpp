    ...
    struct Write : Common {
        ...
        public:
            ...
            static auto process_image (
                ...
                Subprojects::libpng::png_set_IHDR(png_struct, png_info, static_cast<Subprojects::libpng::png_uint_32>(image.width), static_cast<Subprojects::libpng::png_uint_32>(image.height), static_cast<int>(bit_count<Color>()), Subprojects::libpng::$PNG_COLOR_TYPE_RGB_ALPHA, Subprojects::libpng::$PNG_INTERLACE_NONE, Subprojects::libpng::$PNG_COMPRESSION_TYPE_DEFAULT, Subprojects::libpng::$PNG_FILTER_TYPE_DEFAULT);
                Subprojects::libpng::png_write_info(png_struct, png_info);
                for (auto & row : image.data()) {
                    Subprojects::libpng::png_write_row(png_struct, reinterpret_cast<Subprojects::libpng::png_const_bytep>(row.begin()));
                }
