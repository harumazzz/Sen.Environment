                        ...
                        Padding(
                            ...
                            child: SizedBox(
                              ...
                              child: DropdownButtonField<WorldMapEventTutorial>(
                                ...
                                value: event.worldMapTutorial ?? WorldMapEventTutorial.none,
                                items: WorldMapEventTutorial.values
                                    .map((e) => DropdownMenuItem<WorldMapEventTutorial>(
                                          value: e,
                                          child: Text(
                                            e.name,
                                            maxLines: 1,
                        ...
                        Padding(
                            ...
                            child: SizedBox(
                              ...
                              child: DowndropSearchField(
                                ...
                                itemBuilder: (context, String suggestion) {
                                  final plant = gameResource.packet[suggestion] ??
                                ...
                                onSuggestionSelected: (String suggestion) async {
                                  ...
                                  final cubit = context.read<MapEditorConfigurationCubit>();
                                  ...
                                  if (plantType != null && !cubit.state.gameResource.plant.containsKey(plantType)) {
                                    cubit.state.gameResource.plant[plantType] = await cubit.loadPlantVisualAnimation(
                                      ...
                                      plantType,
                                      context.read<SettingBloc>().state.plantCostume,
                                    );
                                  }
