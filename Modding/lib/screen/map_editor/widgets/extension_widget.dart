    ...
    return BlocBuilder<SectionBloc, SectionState>(
        ...
        builder: (context, state) {
          ...
          if (isDesktopPlatform) {
            ...
            if (isLowScreenHeight && extension[ExtensionType.history]! && extension[ExtensionType.layer]!) {
              extension[ExtensionType.history] = false;
            }
            if (isLowScreenHeight && extension[ExtensionType.palette]! && extension[ExtensionType.setting]!) {
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        if (extension[ExtensionType.setting]!) const EditorSettingWidget(),
                      ],
                    ),
                  ],
                ));
