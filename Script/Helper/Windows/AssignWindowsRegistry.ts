namespace Sen.Script.Helper.Windows.AssignWindowsRegistry {
    export function execute() {
        assert(Kernel.OperatingSystem.current() === "Windows", "This method only support Windows machine");
        ...
        const extensions = [".rsb", ".rsg", ".pam", ".rton", ".json", ".png", ".ptx", ".js", ".obb", ".bnk", ".wem", ".scg", ".popfx", ".newton"];
