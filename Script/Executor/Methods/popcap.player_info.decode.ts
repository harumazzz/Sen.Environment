    ...
    */
    ...
    export function forward(): void {
        Sen.Script.Executor.push_as_module<
            Sen.Script.Executor.Methods.PopCap.PlayerInfo.Decode.Argument,
            Sen.Script.Executor.Methods.PopCap.PlayerInfo.Decode.BatchArgument,
            Sen.Script.Executor.Methods.PopCap.PlayerInfo.Decode.Configuration
        >({
            id: "popcap.player_info.decode",
            configuration_file: Home.query("~/Executor/Configuration/popcap.player_info.decode.json"),
