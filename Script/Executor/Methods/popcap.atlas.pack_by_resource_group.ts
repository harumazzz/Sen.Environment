namespace Sen.Script.Executor.Methods.PopCap.Atlas.PackByResourceGroup {
	...
	export function forward(): void {
		return push_as_module<
			Methods.PopCap.Atlas.PackByResourceGroup.Argument,
			Methods.PopCap.Atlas.PackByResourceGroup.BatchArgument,
			Methods.PopCap.Atlas.PackByResourceGroup.Configuration
		>({
