namespace Sen.Script.Executor.Methods.PopCap.RTON.EncodeAndEncrypt {
    ...
    export function forward(): void {
        ...
        >({
            ...
            configuration_file: Home.query("~/Executor/Configuration/popcap.rton.encode_and_encrypt.json"),
            direct_forward(argument: Argument): void {
                ...
                clock.start_safe();
                Kernel.Support.PopCap.RTON.encode_and_encrypt_fs(argument.source, argument.destination!, argument.key!, argument.iv!);
                clock.stop_safe();
                return;
            },
