namespace Sen.Script.Executor.Methods.PopCap.Animation.DecodeAndToFlash {
	...
	export function forward(): void {
		return push_as_module<
			Methods.PopCap.Animation.DecodeAndToFlash.Argument,
			Methods.PopCap.Animation.DecodeAndToFlash.BatchArgument,
			Methods.PopCap.Animation.DecodeAndToFlash.Configuration
		>({
			...
			direct_forward(argument: Argument): void {
				...
				clock.start_safe();
				Kernel.Support.PopCap.Animation.Instance.to_flash(
					argument.source,
