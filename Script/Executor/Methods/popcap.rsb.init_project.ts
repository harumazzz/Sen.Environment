namespace Sen.Script.Executor.Methods.PopCap.RSB.InitProject {
    ...
    export function forward(): void {
        Sen.Script.Executor.push_as_module<
            Sen.Script.Executor.Methods.PopCap.RSB.InitProject.Argument,
            Sen.Script.Executor.Methods.PopCap.RSB.InitProject.BatchArgument,
            Sen.Script.Executor.Methods.PopCap.RSB.InitProject.Configuration
        >({
