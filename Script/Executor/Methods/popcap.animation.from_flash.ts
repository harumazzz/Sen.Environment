namespace Sen.Script.Executor.Methods.PopCap.Animation.FromFlash {
	...
	export function forward(): void {
		return push_as_module<
			Methods.PopCap.Animation.FromFlash.Argument,
			Methods.PopCap.Animation.FromFlash.BatchArgument,
			Methods.PopCap.Animation.FromFlash.Configuration
		>({
			...
			direct_forward(argument: Argument): void {
				...
				clock.start_safe();
				Kernel.Support.PopCap.Animation.FromFlash.convert_fs(
					argument.source,
